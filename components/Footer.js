...
function Footer() {
  return (
    <footer className="bg-paty-cyan bg-opacity-20 sm:h-44 flex flex-col sm:flex-row  items-center justify-center text-black">
      {/* Redes - OK */}
      <div className="sm:w-1/3 w-full h-full flex flex-col justify-evenly p-4 gap-y-2">
        ...
        <div className="flex gap-x-4">
          ...
          <Link href="https://wa.me/5521970181833" target="_blank" passHref>
            <div className="bg-paty-blue flex justify-center items-center shadow-md rounded-lg overflow-hidden w-14 h-14">
